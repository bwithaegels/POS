...
<?php include('includes/sidebar.php');?>
                        ...
                        <div class="col">
                            <div class="card card-cascade reverse  my-4 pb-5">
                                ...
                                <div class="card-footer">
                                    <button name="btn_add" id="btn_add" class="btn btn-xs btn-success float-right" data-toggle="modal" data-target="#modalAddKlant"><i class="fas fa-user-plus"></i> Voeg Toe</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#tblCus_wrapper').find('label').each(function () {
                $(this).parent().append($(this).children());
            });
            $('#tblCus_wrapper .dataTables_filter').find('input').each(function () {
                $('input[type="search"]').attr("placeholder", "Search");
                $('input[type="search"]').removeClass('form-control-sm');
            });
            $('#tblCus_wrapper .dataTables_length').addClass('d-flex flex-row');
            $('#tblCus_wrapper .dataTables_filter').addClass('md-form');
            $('#tblCus_wrapper select').removeClass('custom-select custom-select-sm form-control form-control-sm');   
            $('#tblCus_wrapper select').addClass('mdb-select colorful-select dropdown-ins');
            $('#tblCus_wrapper .mdb-select').materialSelect();
            $('#tblCus_wrapper .dataTables_filter').find('label').remove();
