                ...
                <div class="row">
                    <div class="col">
                        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
                            <h1 class="h2">Aankopen <? echo date('Y'); ?></h1>
                            <div class="btn-toolbar mb-2 mb-md-0">
                                <a class="btn btn-sm btn-outline-secondary" type="button" href="purchaseAdd.php"><i class="fas fa-cart-plus"></i></a>
                            ...
                            <div class="card card-cascade wider reverse  my-4 pb-5">
                                ...
                                <div class="card-body">
                                        ...
                                        <table id="tblSales" class="table table-borderless table-responsive-md btn-table">
                                            <thead>
                                                <tr>
                                                    <th class="th-sm d-none">Type</th>
                                                    <th class="th-sm">Datum</th>
                                                    <th class="th-sm">Leverancier</th>
                                                    <th class="th-sm">Omschrijving</th>
                                                    <th class="th-sm">Bedrag</th>
                                                </tr>
                                            </thead>
